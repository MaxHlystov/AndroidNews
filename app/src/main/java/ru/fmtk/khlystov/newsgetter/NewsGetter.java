...
public class NewsGetter {
       ...
       URL url = new URL(String.format(formatNewsURL, countryCode, BuildConfig.APIkey));
        ...
        try {
            ...
            if (urlConn.getResponseCode() != HttpURLConnection.HTTP_OK) {
                ...
                InputStreamReader inputStreamReader = new InputStreamReader(urlConn.getInputStream(), Charsets.UTF_8);
    ...
    public long copyTo(@NonNull BufferedReader bufferedReader,
